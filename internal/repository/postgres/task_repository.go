...
func (r *Repository) Create(ctx context.Context, task *taskdomain.Task) (*taskdomain.Task, error) {
	...
	row := r.pool.QueryRow(ctx, query,
		...
		task.TemplateID, scheduledForPg(task.ScheduledFor),
...
func (r *Repository) CreateFromTemplate(ctx context.Context, task *taskdomain.Task) error {
	const query = `
		INSERT INTO tasks (title, description, status, template_id, scheduled_for, created_at, updated_at)
		VALUES ($1, $2, $3, $4, $5, $6, $7)
...
func scheduledForPg(t *time.Time) pgtype.Date {
	if t == nil {
